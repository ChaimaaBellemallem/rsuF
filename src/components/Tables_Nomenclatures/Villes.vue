    ...
    <div class="table-crud">
      ...
      <div class="form-row form-ajouter">
        <div class="form-group col-md-5">
          <input type="string" class="form-control" v-model="nom_ville" placeholder="Ville" />
          <p>{{ nom_ville }}</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      data.append("nom_ville", this.nom_ville);
      this.errors = {};
      console.log("sending");
      this.$store.dispatch("addVilles", data);
